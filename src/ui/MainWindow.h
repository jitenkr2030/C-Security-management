...
class ComplaintWidget; class FineWidget;
...
private slots:
    ...
    void showComplaints(); void showFines();
...
private:
    ...
    ComplaintWidget* m_complaints; FineWidget* m_fines;
    ...
    QPushButton* m_btnComplaints; QPushButton* m_btnFines;
