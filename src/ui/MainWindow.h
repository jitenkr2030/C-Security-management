...
private slots:
    ...
    void showIncidents(); void showTraining(); void showDocuments(); void handleLogout();
private:
    void buildUI();
    ...
    VisitorWidget* m_visitors;
    VehicleWidget* m_vehicles;
    IncidentWidget* m_incidents;
    TrainingWidget* m_training;
    DocumentWidget* m_documents;

    QPushButton* m_btnDashboard; QPushButton* m_btnGuards; QPushButton* m_btnClients; QPushButton* m_btnSites;
    QPushButton* m_btnAttendance; QPushButton* m_btnDuty; QPushButton* m_btnLeave; QPushButton* m_btnSalary;
    QPushButton* m_btnUniform; QPushButton* m_btnEquipment; QPushButton* m_btnVisitors; QPushButton* m_btnVehicles;
    QPushButton* m_btnIncidents; QPushButton* m_btnTraining; QPushButton* m_btnDocuments;
    QPushButton* m_btnReports; QPushButton* m_btnSearch; QPushButton* m_btnBackup; QPushButton* m_btnSettings;
